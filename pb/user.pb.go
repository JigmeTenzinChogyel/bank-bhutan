...
type User struct {
	...
	Username          string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // field no are important to uniquely identify the field for serialization
...
const file_user_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAtB.Z,github.com/JigmeTenzinChogyel/bank-bhutan/pbb\x06proto3"
